    ...
    <div className="flex flex-wrap">
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          ...
          <h2 className="text-xl font-semibold mb-2">
            The Roach Runaway Plan:
          </h2>
          <p className="text-gray-600">
            {" "}
            Watch those cockroaches scatter as we implement our Roach Runaway
            Plan. Say goodbye to surprise kitchen visits and hello to a
            roach-free zone!{" "}
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          ...
          <p className="text-gray-600">
            Those mice won't stand a chance against our Mouse Mission Impossible
            team. From stealthy traps to ingenious strategies, we'll make sure
            your cheese stash is safe and sound.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          {/* Use the next/image component */}
          <Image className="h-[30vh]" src={spider} />
          <h2 className="text-xl font-semibold mb-2">Spider-Free Zone: </h2>
          <p className="text-gray-600">
            If you've had enough of those eight-legged roommates, it's time to
            declare your space a Spider-Free Zone! Let us clear out those
            cobwebs and keep your corners critter-free.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          ...
          <h2 className="text-xl font-semibold mb-2">Mosquito Meltdown:</h2>
          <p className="text-gray-600">
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          ...
          <h2 className="text-xl font-semibold mb-2">Cricket Carnival Exit:</h2>
          <p className="text-gray-600">
            If crickets are throwing a loud party in your home, it's time for
            their eviction notice. Our Cricket Carnival Exit will restore peace
            and quiet in no time.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300 pb-10">
          ...
          <h2 className="text-xl font-semibold mb-2">Fly Away Home:</h2>
          <p className="text-gray-600">
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300 pb-10">
          ...
          <h2 className="text-xl font-semibold mb-2">Rat Race Eliminator: </h2>
          <p className="text-gray-600">
            Say farewell to the rat race in your attic or basement. Our Rat Race
            Eliminator will restore your space to a rodent-free zone.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/3 p-4">
        <div className="border border-gray-300 rounded-lg p-4 bg-gray-300">
          ...
          <p className="text-gray-600">
            {" "}
            Introducing the future of pest control! Our Tech-Savvy Pest Control
            utilizes cutting-edge technology to detect, prevent, and eliminate
            pests with the power of innovation.{" "}
          </p>
        </div>
      </div>
    </div>
